...
#define __SSD1331_RES_SET()     HAL_GPIO_WritePin(SSD1331_RES_GPIO_Port, SSD1331_RES_Pin, 1)
#define __SSD1331_RES_CLR()     HAL_GPIO_WritePin(SSD1331_RES_GPIO_Port, SSD1331_RES_Pin, 0)

#define __SSD1331_DC_SET()      HAL_GPIO_WritePin(SSD1331_DC_GPIO_Port, SSD1331_DC_Pin, 1)
#define __SSD1331_DC_CLR()      HAL_GPIO_WritePin(SSD1331_DC_GPIO_Port, SSD1331_DC_Pin, 0)

#define __SSD1331_CS_SET()      HAL_GPIO_WritePin(SSD1331_CS_GPIO_Port, SSD1331_CS_Pin, 1)
#define __SSD1331_CS_CLR()      HAL_GPIO_WritePin(SSD1331_CS_GPIO_Port, SSD1331_CS_Pin, 0)

#define __SSD1331_WRITE_BYTE(__DATA) HAL_SPI_Transmit(&hspi1, &(__DATA),1,100)
